/*
  ...
  /usr/bin/gengetopt -i /tmp/guest-EZIK9T/CSC232/Lab3/odomPub.ggo --file-name odomPub_cmdline --output-dir=/tmp/guest-EZIK9T/CSC232/Lab3/build --unamed-opts 
...
const char *gengetopt_args_info_help[] = {
  ...
  "      --a1=DOUBLE        v  (default=`0')",
  "      --a2=DOUBLE        v  (default=`0')",
  "      --a3=DOUBLE        v  (default=`0')",
  "      --a4=DOUBLE        v  (default=`0')",
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "a1") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->a1_arg), 
                ...
                &(local_args_info.a1_given), optarg, 0, "0", ARG_DOUBLE,
          ...
          else if (strcmp (long_options[option_index].name, "a2") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->a2_arg), 
                ...
                &(local_args_info.a2_given), optarg, 0, "0", ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "a2", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "a3") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->a3_arg), 
                ...
                &(local_args_info.a3_given), optarg, 0, "0", ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "a3", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "a4") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->a4_arg), 
                ...
                &(local_args_info.a4_given), optarg, 0, "0", ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "a4", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "a5") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->a5_arg), 
                ...
                &(local_args_info.a5_given), optarg, 0, "0", ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "a5", '-',
                additional_error))
              goto failure;
          ...
          else if (strcmp (long_options[option_index].name, "a6") == 0)
          {
            ...
            if (update_arg( (void *)&(args_info->a6_arg), 
                ...
                &(local_args_info.a6_given), optarg, 0, "0", ARG_DOUBLE,
                check_ambiguity, override, 0, 0,
                "a6", '-',
                additional_error))
              goto failure;
