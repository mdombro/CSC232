/*
  ...
  /usr/bin/gengetopt -i /tmp/guest-EZIK9T/CSC232/Lab3/ros_subscriber.ggo --file-name ros_subscriber_cmdline --output-dir=/tmp/guest-EZIK9T/CSC232/Lab3/build --unamed-opts 
