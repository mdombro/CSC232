...
#ifndef ODOMPUB_CMDLINE_H
#define ODOMPUB_CMDLINE_H
...
#define CMDLINE_PARSER_PACKAGE "odomPub"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "odomPub"
#endif
...
struct gengetopt_args_info
{
  ...
  double numBeams_arg;	/**< @brief v (default='300').  */
  char * numBeams_orig;	/**< @brief v original value given at command line.  */
  const char *numBeams_help; /**< @brief v help description.  */
  ...
  unsigned int a5_given ;	/**< @brief Whether a5 was given.  */
  unsigned int a6_given ;	/**< @brief Whether a6 was given.  */
  unsigned int sigma_given ;	/**< @brief Whether sigma was given.  */
  unsigned int angleMin_given ;	/**< @brief Whether angleMin was given.  */
  unsigned int angleMax_given ;	/**< @brief Whether angleMax was given.  */
  unsigned int numBeams_given ;	/**< @brief Whether numBeams was given.  */
