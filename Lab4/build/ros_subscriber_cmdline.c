/*
  ...
  /usr/bin/gengetopt -i /tmp/guest-h1YQJU/CSC232/Lab4/ros_subscriber.ggo --file-name ros_subscriber_cmdline --output-dir=/tmp/guest-h1YQJU/CSC232/Lab4/build --unamed-opts 
