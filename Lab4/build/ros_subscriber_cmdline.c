/*
  ...
  /usr/bin/gengetopt -i /tmp/guest-cAui15/CSC232/Lab4/ros_subscriber.ggo --file-name ros_subscriber_cmdline --output-dir=/tmp/guest-cAui15/CSC232/Lab4/build --unamed-opts 
