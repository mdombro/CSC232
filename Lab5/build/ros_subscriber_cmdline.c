/*
  ...
  /usr/bin/gengetopt -i /tmp/guest-Ni8rM1/CSC232/Lab5/ros_subscriber.ggo --file-name ros_subscriber_cmdline --output-dir=/tmp/guest-Ni8rM1/CSC232/Lab5/build --unamed-opts 
