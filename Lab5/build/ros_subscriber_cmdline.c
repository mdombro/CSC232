/*
  ...
  /usr/bin/gengetopt -i /tmp/guest-HcCDfM/csc232/Lab5/ros_subscriber.ggo --file-name ros_subscriber_cmdline --output-dir=/tmp/guest-HcCDfM/csc232/Lab5/build --unamed-opts 
